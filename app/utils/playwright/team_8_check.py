...
def team_8_check():
    with sync_playwright() as p:
        ...
        page.goto(os.getenv("TEAM_8_URL"))

        page.set_viewport_size({"width": 1080, "height": 1024})

        # This team has a different structure - we need to evaluate it differently
        result = []
    ...
    # save_all_depth_charts(result=result, team_id=8, year=2024)
